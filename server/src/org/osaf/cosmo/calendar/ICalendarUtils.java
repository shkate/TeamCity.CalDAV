...
public class ICalendarUtils {
  ...
  public static Calendar createBaseCalendar(Component comp) {
    Calendar cal = createBaseCalendar(Constants.CALENDAR_UID);
   ...
   * @return base Calendar
   */
  public static Calendar createBaseCalendar(String icalUid) {
    Calendar cal = new Calendar();
    cal.getProperties().add(Version.VERSION_2_0);
    cal.getProperties().add(new ProdId(icalUid));
